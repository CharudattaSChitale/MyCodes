...
public class SetThread extends BenchmarkThread {
	...
	TreeMap<Integer, OptimisticBoostedBucketList.WriteSetEntry> list_writeset = new TreeMap<Integer, OptimisticBoostedBucketList.WriteSetEntry>(
	...
	ArrayList<OptimisticBoostedBucketList.ReadSetEntry> list_readset = new ArrayList<OptimisticBoostedBucketList.ReadSetEntry>();
	
	ArrayList<OptimisticBoostedBucketList> list_HashmapWriteset = new ArrayList<OptimisticBoostedBucketList>();
	
	 protected volatile int count=0;
	
	/*TreeMap<Integer, OptimisticBoostedBucketList.WriteSetEntry> skiplist_writeset = new TreeMap<Integer, OptimisticBoostedBucketList.WriteSetEntry>(
			new Comparator<Integer>() {
				@Override
				public int compare(Integer o1, Integer o2) {
					return o2 - o1;
...
//									initial_adds++;
				...
				//System.out.println(nb_succ_remove);
				m_set.commit();
